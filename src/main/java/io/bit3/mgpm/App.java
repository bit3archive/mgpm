...
public class App {
  ...
  public static void main(String[] cliArguments) {
    ...
    System.setProperty("org.slf4j.simpleLogger.defaultLogLevel", args.getLoggerLevel());
    System.setProperty("org.slf4j.simpleLogger.log.io.bit3.mgpm", args.getLoggerLevel());
